...
short_description: This module is used for getting the incremental values  by comparing all.yml and show run nve parser  
...
def compare(userinput:dict,parsed_output:dict,tocompare:dict , overlay_intf:dict)->dict:
    ...
    yml_dict_output =  {'vrf_cli' : mul_list_dict['vrf'] , 'vlan_cli' : mul_list_dict['vlan_svi'] , 'svi_cli' : mul_list_dict['vlan_svi'] ,'ovrl_intf_cli' : mul_list_dict['overlay_inft']  }
